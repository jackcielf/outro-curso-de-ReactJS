...
export default function App() {
    ...
    const somaNotas = parseFloat(notas.nota1) + parseFloat(notas.nota2) + parseFloat(notas.nota3) + parseFloat(notas.nota4);

    return (
        <>
            <h1>Elevação do state</h1>

            <Nota name={"nota1"} num={1} nota={notas.nota1} setNota={handleSetNotas} />
            <Nota name={"nota2"} num={2} nota={notas.nota2} setNota={handleSetNotas} />
            <Nota name={"nota3"} num={3} nota={notas.nota3} setNota={handleSetNotas} />
            <Nota name={"nota4"} num={4} nota={notas.nota4} setNota={handleSetNotas} />
            <Resultado somaNotas={somaNotas} />
